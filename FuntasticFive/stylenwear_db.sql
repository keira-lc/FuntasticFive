...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 24, 2025 at 03:01 AM
...
CREATE TABLE `orders` (
  ...
  `data_ordered` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
